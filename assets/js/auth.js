...
function initAuthUI() {
    ...
    if (user) {
        ...
        // Not logged in
        authBtnContainer.innerHTML = `
            <button onclick="showLoginModal()" style="background: #ea580c; border: none; color: white; padding: 4px 14px; border-radius: 20px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 6px; font-size: 0.8rem; transition: all 0.3s ease; box-shadow: 0 4px 10px rgba(234, 88, 12, 0.3);">
