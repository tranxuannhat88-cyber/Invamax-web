...
function renderPreliminary(res, factoryInfo, contactInfo, rawAnswers) {
    // Basic replacements
    document.getElementById('a4-company').innerText = factoryInfo['A01'] || 'Không rõ';
    document.getElementById('a4-product').innerText = factoryInfo['A04'] || 'Không rõ';
    document.getElementById('a4-name').innerText = contactInfo['F01'] || 'Không rõ';
    document.getElementById('a4-job').innerText = contactInfo['F02'] || 'Không rõ';
    const phone = contactInfo['F04'] || '';
    document.getElementById('a4-phone').innerText = phone || 'Không rõ';
    ...
    document.getElementById('a4-score-text').innerText = `${healthScore} / 100`; // Sửa lại thành healthScore
    ...
    document.getElementById('a4-recommendation-text').innerText = "HÀNH ĐỘNG KHUYẾN NGHỊ: " + res.nextSteps;
...
function exportPDF(type = 'chi-tiet') {
    ...
    const companyName = document.getElementById('a4-company').innerText.replace(/\s+/g, '_');
