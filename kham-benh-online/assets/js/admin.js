...
const KNOWLEDGE_BASE_TEXT = `NỀN FOS KNOWLEDGE BASE:
1. 11 Module NỀN FOS (bắt buộc đúng thứ tự): Knowledge, Digital, Quality, People, Flow, Standard, Capacity, Daily Management, Core, Sustain, Kaizen.
...
3. Phát hiện lỗi từ vựng ở top3Wastes và sửa thành đúng chuẩn NỀN FOS trong phần "diagnostic.correctedWastes" (Phải dùng đúng "Lãng phí nguồn lực" và "Quy trình thừa").
...
JSON SCHEMA BẮT BUỘC:
{
  ...
  "report": { "status": "TEST_MODE" }
    ...
    try {
        ...
        if (errors.length === 0) {
            Swal.fire('PASS', 'AI Profile đã vượt qua mọi bài kiểm tra khắt khe của NỀN FOS Expert!', 'success');
        } else {
